...
base_map <- function(r, title, pal) {
  ggplot() +
    ...
    theme(legend.key.width = unit(0.25, "cm"), axis.title = element_blank())
}

base_map(elev, "(a) Elevation (m)", "viridis") +
  base_map(vri[["BASAL_AREA"]], "(b) Basal area (m2/ha)", "mako") +
  base_map(mmb, "(c) MicroMet wind weighting", "cividis")
```
...
#| label: appendix-s2
#| echo: false
#| tbl-cap: "**Appendix S2.** Annual model comparison. Each model adds one pathway to the previous."
...
#| label: appendix-s4
#| echo: false
#| tbl-cap: "**Appendix S4.** Stand structure across the study perimeter, from the Vegetation Resources Inventory."
...
#| label: appendix-s5
#| echo: false
#| tbl-cap: "**Appendix S5.** Moderate-to-high beetle disturbance by quadratic mean diameter class, on the balanced sample. The 25 cm boundary is the source-sink threshold of the species' bionomics."
