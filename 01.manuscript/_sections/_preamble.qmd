...
## M5, the annual model carrying the terrain-resolved MicroMet field, was removed on
## 2026-08-31 with the annual-against-sixteen-day comparison it existed to support. The
## wind claim now rests on the 16-day models E1 and E2, where the same field varies within
## the season and the interaction is identified. Nothing printed in the manuscript read a
## coefficient from M5.
