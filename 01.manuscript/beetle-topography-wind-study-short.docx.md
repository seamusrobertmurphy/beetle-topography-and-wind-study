...
::: {#tbl-m3 .cell tbl-cap='Full model, continuous terms. Coefficients are per standard deviation on a class-balanced sample, so the intercept is not landscape prevalence. The geomorphon landform classes are also in this model and are not reported here.'}
::: {.cell-output-display}


|                                          |Term                                      |   Beta|    SE|     z|       p|
|:-----------------------------------------|:-----------------------------------------|------:|-----:|-----:|-------:|
|solar_flight_direct                       |solar_flight_direct                       | +0.487| 0.028|  17.2| < 0.001|
|PINE_BA                                   |PINE_BA                                   | +0.459| 0.014|  32.4| < 0.001|
|QUAD_DIAM_125                             |QUAD_DIAM_125                             | -0.422| 0.023| -18.4| < 0.001|
|northness                                 |northness                                 | +0.382| 0.016|  23.2| < 0.001|
|LIVE_STAND_VOLUME_125                     |LIVE_STAND_VOLUME_125                     | +0.381| 0.024|  15.6| < 0.001|
|wind_effect                               |wind_effect                               | +0.358| 0.029|  12.4| < 0.001|
|elevation                                 |elevation                                 | +0.329| 0.018|  18.2| < 0.001|
|VRI_LIVE_STEMS_PER_HA:wind_effect         |VRI_LIVE_STEMS_PER_HA:wind_effect         | +0.221| 0.021|  10.6| < 0.001|
|PROJ_AGE_1                                |PROJ_AGE_1                                | +0.218| 0.018|  11.9| < 0.001|
|jul                                       |jul                                       | +0.215| 0.012|  17.8| < 0.001|
|valley_depth                              |valley_depth                              | -0.193| 0.022|  -8.7| < 0.001|
|CROWN_CLOSURE                             |CROWN_CLOSURE                             | -0.183| 0.020|  -9.0| < 0.001|
|VRI_LIVE_STEMS_PER_HA:solar_flight_direct |VRI_LIVE_STEMS_PER_HA:solar_flight_direct | -0.144| 0.017|  -8.6| < 0.001|
|jun                                       |jun                                       | +0.107| 0.012|   8.7| < 0.001|
|VRI_LIVE_STEMS_PER_HA                     |VRI_LIVE_STEMS_PER_HA                     | -0.099| 0.018|  -5.4| < 0.001|
|twi                                       |twi                                       | +0.073| 0.019|   3.7| < 0.001|
|midslope_position                         |midslope_position                         | +0.063| 0.013|   4.7| < 0.001|
|vrm                                       |vrm                                       | -0.043| 0.019|  -2.2|   0.027|
|tpi                                       |tpi                                       | +0.040| 0.023|   1.8|   0.076|
|curv_prof                                 |curv_prof                                 | -0.038| 0.012|  -3.0|   0.002|
|tri                                       |tri                                       | -0.036| 0.023|  -1.5|   0.124|
|convergence                               |convergence                               | -0.029| 0.014|  -2.1|   0.038|
