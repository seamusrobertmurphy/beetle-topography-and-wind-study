...
at its 16-day repeat: `r EP_EPOCHS` epochs across `r spellnum(EP_YEARS)` outbreak years,
...
from `r bnr(I_GEO)` to `r b3(I_GEO)`. And inventory vintage governs what can be detected at
