...
#
# Run: /usr/local/bin/Rscript 02.inputs/beetle-classification/01-scene-metadata.R
...
write.csv(sc, "02.inputs/beetle-classification/landsat-scene-inventory.csv",
          row.names = FALSE)
cat("\nWrote 02.inputs/beetle-classification/landsat-scene-inventory.csv\n")
